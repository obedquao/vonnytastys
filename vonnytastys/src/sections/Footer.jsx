...
export default function Footer() {
  return (
    <section className="bg-black p-8 md:p-16">
      <div className="flex flex-col md:flex-row gap-16 justify-between">
        <div className=" flex flex-row items-center justify-center ">
          <img src="/logo.png" alt="logo" className="w-32 h-auto " />
        </div>

        <div className="flex items-center flex-col md:flex-row justify-center gap-10 text-center">
          <div className="flex flex-col items-center md:items-start justify-center gap-2">
            <h4 className="text-lg font-bold mb-6 font-playfair text-white">
              Contact
            </h4>
          ...
          <div className="flex flex-col font-poppins md:justify-start">
            <h4 className="font-bold mb-4 font-playfair text-white">
              Navigation
            </h4>
        ...
        <div className="flex flex-col justify-center gap-3">
          <h3 className="text-center text-white">Follow our socials</h3>
